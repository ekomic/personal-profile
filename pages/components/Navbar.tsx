...
const Navbar: React.FC = () => {
  ...
  return (
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300">
      <div>
        <img src="/cde.png" alt="" width="50px" />
      </div>
      {/* menu */}
      ...
      <div className="hidden lg:flex fixed flex-col top-[35%] left-0">
        <ul>
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-blue-600">
            <Links href="https://www.linkedin.com/in/ekomic/">
              <a
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#333333]">
            <Links href="https://github.com/ekomic">
              <a
                className="flex justify-between items-center w-full text-gray-300"
                target="_blank"
              >
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#3e7bec]">
            <Links href="https://twitter.com/ekomdamalu2016">
              <a
                className="flex justify-between items-center w-full text-gray-300"
                target="_blank"
              >
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#565f69]">
            <Links href="https://docs.google.com/document/d/1KEoR6R8betuELl1-i1uYTR8CuGocCusKD4WxdP9scI4/edit?usp=sharing">
              <a
                className="flex justify-between items-center w-full text-gray-300"
                target="_blank"
              >
